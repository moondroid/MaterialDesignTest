...
public class CardViewFragment extends Fragment {
    ...
    private static final int MAX_CORNER_RADIUS = 30;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRadiusSeekBar.setMax(MAX_CORNER_RADIUS);
        mRadiusSeekBar.setProgress((int) mCardView.getRadius());
        ...
        mElevationSeekBar.setMax((int) mCardView.getMaxCardElevation());
